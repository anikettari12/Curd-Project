...
function updateRecord(formData){
   ...
   selectedRow.cells[3].innerHTML = formData.prePrice;
}

//delete the record
function onDelete(td) {
     if(confirm("Do you want to delete this recod"))
     {
